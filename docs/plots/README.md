...
every stage of the run rather than at the end, and `genomic.pdf`,
`spatial.pdf` and `combined.pdf`, the final four as two figures and as one page.
...
## `genomic.pdf`, `spatial.pdf` and `combined.pdf`

The final four as two figures at a text column (#309, #280, #339).
`genomic.pdf` is 122 mm wide and `llncs`'s 193 mm text height less 1.5 in
