...
6 to 12 um is 1.5 to 3 pixels across its radius. 24 is also what a
0.48-linewidth panel of a 6.5 in column resolves at 300 dpi over 40 spots
(#280), so the slide is drawn at about one pixel per device pixel.
"""
