...
| `cnamaste/` | `cnaster` at the lock's pin, renamed, with the default patches folded in (#392); `VENDOR.toml` states what it holds, `cnamaste/tests` tests it without `cnaster` |
