...
| step | class | why |
| --- | --- | --- |
| the fused field, written into a buffer | **could be upstream** | `oxisal.external_field(totals, successes, ..., field)` is this function, in Rust, writing in place. What it cannot take is the per-observation exposure and trials, which is #32's covariate gap |
